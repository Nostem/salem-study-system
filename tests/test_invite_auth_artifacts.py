...
class InviteAuthArtifactTests(unittest.TestCase):
    ...
    def test_quiz_history_edge_function_is_user_scoped_and_returns_review_shape(self):
        ...
        self.assertIn("createAdminClient", history)
        self.assertIn("requireUser", history)
