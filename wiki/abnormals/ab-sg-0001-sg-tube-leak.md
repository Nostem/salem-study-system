...
A <span class="hi-exam">500 gpd SGTL ramps in on 23 SG</span> (entry cue OHA A-6 RMS HI RAD OR TRBL, 2R53C then 2R19C/2R15/2R41D rising). CRS contacts RP for the primary-to-secondary leak rate response and enters AB.SG-0001; the crew quantifies the leak, identifies 23 as the affected SG, raises the 23MS10 setpoint to 1045 psig, closes 23GB4/23MS7/23MS18, and re-aligns SG blowdown and MS sampling to the Waste System. CRS dispatches an operator to shut 23MS45 and enters TSAS 3.7.1.3 for 23 AFW pump. The leak meets <span class="hi-exam">CAS Action Level 3 per Step 6.2.A (leak rate &ge; 75 gpd AND rate of change &ge; 30 gpd/hr)</span> ⇒ power <span class="hi-exam">&lt;50% within 1 hour</span> and Mode 3 within 2 hours; CRS enters TSAS 3.4.7.2.c (leak &gt; 150 gpd) and directs a Rapid Load Reduction. The leak then escalates to a tube rupture, driving the reactor trip and SI.
</div>
...
### Subcooling & Tube Rupture Escalation
...
- Related scenarios: [[2016 Scenario 2 — 2C EDG Pre-Lube Failure / Condensate Pump Trip / 21 SGTL → SGTR / Stuck-Open PORV]], [[2017 Scenario 8]], [[2022 Scenario 4]], [[2020 Scenario 4 — SGTR / PORV Failure]], [[2014 Scenario 4 — Steam Generator Tube Rupture without Pressurizer Pressure Control]], [[2012 Scenario 2]]
- Related exam: [[2015 NRC Written Exam]], [[2016 NRC Written Exam]], [[2016 NRC Operating Exam]], [[2017 NRC Operating Exam]], [[2018 NRC Written Exam]], [[2019 NRC Written Exam]], [[2019 NRC Operating Exam]], [[2020 NRC Operating Exam]], [[2022 NRC Operating Exam]], [[2023 NRC Written Exam]], [[2014 NRC Operating Exam]], [[2012 NRC Written Exam]], [[2012 NRC Operating Exam]]
