...
The radiation protection program ensures that occupational radiation exposures are maintained as low as reasonably achievable (ALARA) and within 10CFR20 limits. The program covers shielding design, ventilation for contamination control, personnel monitoring, access controls, and administrative procedures. (UFSAR 12)
