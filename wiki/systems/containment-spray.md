...
The primary purpose of the Containment Spray System is to spray cool water into the containment atmosphere following a loss-of-coolant accident (LOCA) and thereby ensure that containment pressure does not exceed the design value of <span class="val-trip">47 psig at 271°F</span> (100 percent relative humidity). This protection is afforded for all pipe break sizes up to and including the hypothetical instantaneous circumferential rupture of a reactor coolant pipe; the design is based on the conservative assumption that the core residual heat is released to the containment as steam (UFSAR §6.2.2.1.1).

The system is designed to spray at least <span class="val-normal">2600 gpm</span> of borated water into the Containment Building whenever two-out-of-four (hi-hi) containment pressure signals occur or a manual signal is given. Either of the two subsystems — each containing a pump and associated valving and spray headers — is independently capable of delivering 2600 gpm (UFSAR §6.2.2.1.1).

A second purpose served by the Containment Spray System, including the recirculation phase, is to remove fission products (primarily iodine) from the containment atmosphere should they be released in the event of a LOCA. One containment spray pump and recirculation spray provide sufficient iodine scrubbing capability to ensure that post-accident fission product leakage (based on Reg. Guide 1.183 release fractions) would not result in doses exceeding the limits of 10CFR50.67 (UFSAR §6.2.2.1.3).

Any single failure of an active component in either spray subsystem does not degrade the minimum containment cooling or fission-product-removal capability of the system; the containment pressure-temperature analysis in Section 15 assumes the most restrictive single failure (UFSAR §6.2.2.1.1). System active components are redundant, and system piping located within containment is redundant and separable in arrangement (UFSAR §6.2.2.1.1). The single-failure analysis is summarized in UFSAR Table 6.2-4.

## Key Components

The principal components of the Containment Spray System are: two pumps, one spray additive tank, two eductors, spray ring headers and nozzles, and the necessary piping and valves. The containment spray pumps and the spray additive tank are located in the Auxiliary Building, and the spray pump suctions are normally lined up to the RWST (UFSAR §6.2.2.1.2). All associated components, piping, structures, and power supplies are designed to Class I (seismic) criteria (UFSAR §6.2.2.1.2). Code requirements are tabulated in UFSAR Table 6.2-1 (spray additive tank: ASME Section VIII; valves: ANSI B16.5; piping/pumps/headers/nozzles: ANSI B31.1). The system piping is designed for <span class="val-normal">250 psig at 150°F</span> (UFSAR §6.2.2.1.2).

**Containment Spray Pumps** — two horizontal centrifugal pumps driven by electric motors that can be supplied from the standby ac power supply. Design head is sufficient to continue at rated capacity with a minimum level in the RWST against a head equal to the sum of the containment design pressure, the head to the uppermost nozzles, and line and nozzle pressure losses; motors are non-overloading to the end of the pump curve. Materials of construction are stainless steel or equivalent corrosion-resistant material (UFSAR §6.2.2.1.2). Design parameters (UFSAR Table 6.2-2):

| Parameter | Value | Source |
|-----------|-------|--------|
| Quantity | 2 | UFSAR Table 6.2-2 |
| Design discharge pressure | <span class="val-normal">250 psig</span> | UFSAR Table 6.2-2 |
| Design temperature | <span class="val-normal">150°F</span> | UFSAR Table 6.2-2 |
| Design flow rate | <span class="val-normal">2600 gpm</span> | UFSAR Table 6.2-2 |
| Design head | <span class="val-normal">450 ft</span> | UFSAR Table 6.2-2 |
| Shutoff head | ~530 ft | UFSAR Table 6.2-2 |
| Motor | 400 hp | UFSAR Table 6.2-2 |
| Type | Horizontal-Centrifugal | UFSAR Table 6.2-2 |

**Spray Additive Tank** — a single tank holding a sodium hydroxide solution whose concentration assures the injection spray pH will be at least 8.5. The tank capacity is sufficient that, upon mixing with refueling water from the RWST, boric acid from the boron injection tank (BIT — Unit 2 only), borated water from the accumulators, and primary coolant, the containment sump pH will be greater than 7.0 — assuring retention of absorbed iodine in the sump liquid and minimizing chloride-induced stress corrosion cracking of stainless steel (UFSAR §6.2.2.1.2). A Control Room level-indicating alarm warns if the solution tank contains less than the required amount of NaOH; a Control Room flow indication alerts the operator to low flow from the tank when required (UFSAR §6.2.2.1.2). Tank design parameters (UFSAR Table 6.2-3): one tank, total volume (empty) <span class="val-normal">4000 gal</span>, NaOH concentration <span class="val-normal">30 w/o</span>, design temperature 300°F, design pressure 14 psig, austenitic stainless steel.

**Spray Headers and Nozzles** — the arrangement consists of four 360-degree ring headers at different elevations, with alternate headers connected. The header diameters are 101 feet at Elevation 244 feet-6 inches, 96 feet at Elevation 247 feet-0 inch, 53 feet at Elevation 266 feet-6 inches, and 48 feet at Elevation 269 feet-0 inch. The spray headers and nozzles are stainless steel of a hollow-cone pressure nozzle design, with a <span class="hi">3/8-inch diameter orifice</span> and no internal parts subject to clogging. The nozzles produce a drop-size spectrum with a Sauter mean drop size of less than 1000 microns with the spray pump operating at design conditions and the containment at full design pressure and temperature (UFSAR §6.2.2.1.2). During spray recirculation operation, the water is screened through <span class="hi">1/12-inch (2.1 mm) diameter holes</span> before leaving the containment sump (UFSAR §6.2.2.1.2). On Unit 2 the ring header piping is supported and accessed by the Containment Dome Access System, a seismic Class I orbital inclined service bridge and supporting structure (UFSAR §6.2.2.1.2).

**Heat Exchangers** — the two residual heat exchangers used during the recirculation phase are described in UFSAR Section 6.3 (UFSAR §6.2.2.1.2).

**Eductors** — during the period the spray pumps draw from the RWST, a small portion of the spray flow is diverted from the spray pump discharge line through the eductor and back to the pump suction; the liquid from the spray additive tank then mixes with the liquid entering the pump suction, producing a solution suitable for removal of iodine. Valve CS14 in the spray additive tank discharge line is provided with redundant position indication to assure effective chemical addition to the spray system (UFSAR §6.2.2.1.2). Parts of the system in contact with borated water, sodium hydroxide spray additive, or mixtures of the two are stainless steel or an equivalent corrosion-resistant material (UFSAR §6.2.2.1.3).
...
The two containment spray pumps are driven by electric motors that can be supplied with power from the standby ac power supply (UFSAR §6.2.2.1.2). At Salem the 21 CS pump is powered from the 2A 4KV Vital Bus and the 22 CS pump from the 2C 4KV Vital Bus (see Exam — 2022 Q42). Safeguards-mode pump starts are sequenced by the SEC (see Exam — 2015 Q45). Containment cooling design basis for containment integrity is one containment spray train plus three of the five fan coolers, along with one train of the ECCS (UFSAR §6.2.2.1.3; see Exam — 2012 Q45).
...
The spray system is actuated by two-out-of-four (hi-hi) containment pressure signals. The starting signal energizes the pumps and opens the discharge valves to the spray headers; the valves associated with the spray additive tank are opened on the same signal. If necessary, the operator can manually actuate the entire system from the control room (UFSAR §6.2.2.1.2). At Salem the hi-hi ("P") signal trips at <span class="val-trip">15.0 psig</span> (2/4) and also actuates Phase B containment isolation. **Containment Spray bistables are energized to actuate** (opposite of most ESF bistables) (UFSAR T7.2-1, TS Table 3.3-4).

The starting sequence of the containment spray pumps and their related emergency power equipment is designed so that delivery of the required spray into containment is reached in <span class="val-normal">85 seconds</span> following the appropriate initiating trip signal. This time delay includes consideration of signal delay, assumed loss of offsite power, diesel start time, breaker closure, SEC sequencing, and the time required for the spray pumps to reach full speed and fill the spray headers and piping; the delay is consistent with the Section 15 safety analysis and the Tech Spec limit for containment spray pump response (UFSAR §6.2.2.1.3).
...
Adequate containment cooling and iodine removal are provided by components that operate in two sequential modes (UFSAR §6.2.2.1.2):

1. **Injection** — a portion of the contents of the refueling water storage tank (RWST) is sprayed into the containment atmosphere using the containment spray pumps; the contents of the spray additive tank (sodium hydroxide) are mixed into the spray stream to enhance iodine removal.
2. **Recirculation** — water from the containment sump is recirculated by diverting a portion of the recirculation flow from the discharge of the residual heat removal (RHR) heat exchangers to the containment spray header after injection from the RWST has been terminated.

The Spray System reduces post-accident temperature and pressure by condensing steam. During the injection and recirculation phases, the spray water is raised to the temperature of the containment in falling through the steam-air mixture; the minimum fall path of the droplets is approximately <span class="hi">116 feet</span> from the lowest spray ring headers to the operating deck. Heat transfer calculations show thermal equilibrium is reached by all droplets in the first few feet of their fall, so the spray water reaches essentially the containment saturation temperature (UFSAR §6.2.2.1.3). Spray evaluation parameters (UFSAR Table 6.2-9) include containment pressure 61.7 psia, containment temperature 271°F, injection spray flow 2600 gpm, recirculation spray flow 1900 gpm, injection spray pH 8.5 to 10.0, and minimum spray coverage 0.75.

The NaOH additive maintains post-LOCA sump pH greater than 7.0 (injection spray pH at least 8.5), which assures adequate retention of absorbed iodine in the sump liquid and minimizes chloride-induced stress corrosion cracking of stainless steel (UFSAR §6.2.2.1.2). The spray nozzles have no internal parts subject to clogging, and during recirculation the water is screened through 1/12-inch (2.1 mm) diameter holes before leaving the containment sump (UFSAR §6.2.2.1.2). Adequate sump level for suction is assured: the total quantity of water released to containment at the beginning of recirculation, assuming a DBA with reactor coolant loop piping half full, is approximately 275000 gallons; discounting water trapped in the refueling canal and instrumentation tunnel, the volume available at the RHR pump suction used for containment spray is approximately 190000 gallons, leaving a water level several feet above the 8-foot-deep containment sump top (UFSAR §6.2.2.1.3). NPSH for the containment spray and RHR pumps is given in UFSAR Table 6.2-6 (Containment Spray pump: available NPSH 29.9 ft vs required 10 ft at 2600 gpm rated flow from the RWST; RHR pump in recirculation: available 28.1 ft Unit 1 / 25.7 ft Unit 2 vs required 22 ft at 4850 gpm).
...
During the injection phase, the containment spray pumps take suction from the RWST, whose liquid capacity the Containment Spray System shares with the SIS (UFSAR §6.2.2.1.2). During the recirculation phase the system utilizes the two RHR pumps, two residual heat exchangers, and associated valves and piping of the SIS: if the containment pressure should increase, the operator can direct part of the discharge flow from the residual heat exchangers to the spray headers, thereby initiating recirculation spray flow (UFSAR §6.2.2.1.2). The valves, piping, and motors for the Containment Spray System are designed in accordance with the SIS specifications described in UFSAR Section 6.3 (UFSAR §6.2.2.1.2). The Containment Spray System initially operates independently of other ESF following a LOCA and provides containment cooling in combination with the Containment Fan Cooling System; for extended recirculation-mode operation, water is supplied through the RHR pumps and heat exchangers (UFSAR §6.2.2.1.3).
...
A single-failure analysis on all active components shows that failure of any single component will not prevent the system fulfilling its design function (UFSAR §6.2.2.1.3; UFSAR Table 6.2-4). Two containment spray pumps are provided with evaluation based on operation of one pump in addition to three of the five containment cooling fans during the injection phase; the automatically operated spray pump discharge isolation valves have two complete systems provided; the spray additive tank outlet isolation valve has two parallel valves (operation of one required); and in recirculation the containment sump isolation valve has two lines in parallel and the spray header isolation valve from the residual heat exchangers has two complete loops (operation of one required) (UFSAR Table 6.2-4).
...
If necessary, the operator can manually actuate the entire system from the control room (UFSAR §6.2.2.1.2). After the injection operation, spray pump flow is discontinued when the water in the RWST is depleted; containment pressure control can then be maintained with the RHR System functioning through the containment spray headers. A Control Room level-indicating alarm and a Control Room flow indication support operation of the spray additive tank (UFSAR §6.2.2.1.2). At Salem, EOP-LOCA-5 Table C is used to determine the number of containment spray pumps required as a function of RWST level, containment pressure, and number of CFCUs running, to conserve RWST inventory.
...
- Spray additive tank (TS 3.6.2.2): 2568–4000 gallons of 30–32% by weight NaOH; eductor flow 35 ±3.5 gpm to each containment spray system; spray pump differential pressure ≥204 psid per IST program (TS SR 4.6.2.1, TS SR 4.6.2.2)
