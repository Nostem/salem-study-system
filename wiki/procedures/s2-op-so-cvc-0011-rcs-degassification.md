---
title: "S2.OP-SO.CVC-0011 — RCS Degassification"
category: procedures
status: draft
aliases:
  - S2.OP-SO.CVC-0011
...
# S2.OP-SO.CVC-0011 — RCS Degassification

## Purpose

System operating procedure for removing dissolved hydrogen from the Reactor Coolant System prior to a cooldown for a refueling outage. Both chemical degassification (peroxide addition) and mechanical degassification (replacing H2 with N2 in the VCT) are used to lower RCS hydrogen before the system is opened to atmosphere.
...
- Related exam questions: [[2015 Q33]]
