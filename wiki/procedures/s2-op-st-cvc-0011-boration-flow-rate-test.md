---
title: "S2.OP-ST.CVC-0011 — Boration Flow Rate Test"
category: procedures
status: draft
aliases:
  - S2.OP-ST.CVC-0011
  - Boration Flow Rate Test
  - Boration Flow Capability to the RCS Surveillance Test
---

# S2.OP-ST.CVC-0011 — Boration Flow Rate Test

> ⚠️ DRAFT — Reconstructed from exam materials

## Purpose

Surveillance procedure that demonstrates Boration Flow Capability to the RCS — verifying both the normal makeup boration flowpath and the rapid borate flowpath deliver the required boric acid flow. Satisfies the flow-rate acceptance criterion of Tech Spec Surveillance 4.1.2.2.d. Performed in Modes 3–6 or Defueled (or during Refueling Outages in Modes 1 and 2 provided rapid boration is started immediately prior to the Reactor Trip).
