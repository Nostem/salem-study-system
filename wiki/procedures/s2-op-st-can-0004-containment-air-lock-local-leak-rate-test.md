...
Local leak rate test of the containment personnel air lock (100' elevation airlock). Verifies the air lock satisfies the leakage acceptance criteria of TS 3.6.1.3 (Containment Air Locks).
