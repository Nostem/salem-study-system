---
title: "EP-SA-111 — Emergency Classification and Protective Action"
category: admin
status: draft
aliases:
  - EP-SA-111
...
PAR determination via Appendix 1: GE from loss of all AC power (not based on loss of 3 fission product barriers, not hostile action) — select <span class="hi-exam">Default PAR (No RPSA): Evacuate 0-5 miles, Monitor &amp; Prepare 5-10 miles</span>.
</div>
...
| Step | Organization | Primary Contact | Phone |
|------|-------------|----------------|-------|
| 15.a | NJ State Police | NETS 5400 | Primary |
| 15.b-d | NJ Counties | Salem County, Cumberland County | NETS |
| 15.e | Delaware State Police / DEMA | NETS 5406 | Primary; Secondary: 302-659-2341; Backup: NAWAS |
