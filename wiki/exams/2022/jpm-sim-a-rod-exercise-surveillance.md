---
title: "2022 JPM Sim-a — Perform Control Rod System Surveillance"
category: exams
status: draft
aliases:
  - 2022 JPM Sim-a
...
<span style="color:#34d399;font-size:14px;font-weight:600;">JPM Sim-a — Perform Control Rod System Surveillance</span>
<span style="font-size:10px;padding:2px 8px;background:#0d1220;color:#6b7280;border-radius:3px;">Sim | RO | 001 A2.11 (RO 0 / SRO 0)</span>
</div>
...
- The rod control system surveillance is in progress. All sections are complete, except for exercising Control Bank D.<br><br>
...
<span style="color:#c8cdd5;">Exercises Control Bank D at least 10 steps and upon completion of the test recognizes unexpected continuous rod movement requiring a manual reactor trip.</span>
</div>
...
<td style="padding:6px;color:#9ca3af;">Checks Tave/Tref recorder on 2RP4 and determines Tavg is within +/-1F of Tref.</td>
</tr>
<tr style="border-bottom:1px solid #0d1220;">
...
<td style="padding:6px;color:#c8cdd5;">Ensure GRP SELECT B lights illuminated on Cabinets 21BD and 22BD</td>
<td style="padding:6px;color:#9ca3af;">Contacts Maintenance Technician at Power Cabinets. Technician reports GRP SELECT B lights are illuminated.</td>
</tr>
<tr style="border-bottom:1px solid #0d1220;">
<td style="padding:6px;color:#c8cdd5;">4.1.10.4-5</td>
<td style="padding:6px;color:#c8cdd5;">Insert/Withdraw Control Bank D 1 step (repeat 3 times)</td>
<td style="padding:6px;color:#9ca3af;">Inserts one step, withdraws one step. Repeated three times consecutively.</td>
</tr>
<tr style="border-bottom:1px solid #0d1220;">
...
<td style="padding:6px;color:#9ca3af;">Records test results as SAT using Acceptance Criteria in Attachment 1, Rod Control Assembly Data.</td>
</tr>
<tr style="border-bottom:1px solid #0d1220;">
...
Ref: S2.OP-ST.RCS-0001 (Rev 25) | Task: 50638 | K/A: 001 A2.11 — Ability to predict the impacts of continuous rod insertion/withdrawal on reactor power (4.4/4.7) | Safety Fn: 1 | Source: Bank | <a href="/salem-study-system/exam-pdfs/2022-jpm-sim-a.pdf" target="_blank" style="color:#60a5fa;">View JPM PDF</a>
</div>
</div>
</details>
</div>
