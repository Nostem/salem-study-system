---
title: "2023 Q7 — PZR Backup Heater Power Supplies"
category: exams
status: verified
reference: no
aliases:
...
<span style="font-size:10px;padding:2px 8px;background:#0d1220;color:#6b7280;border-radius:3px;">WE12 AK2.03c (RO 3.2 / SRO 3.2)</span>
</div>
