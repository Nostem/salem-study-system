...
<span style="font-size:10px;padding:2px 8px;background:#0d1220;color:#6b7280;border-radius:3px;">In-Plant | RO/SRO | 056 AA1.37 (RO 3.4 / SRO 3.4)</span>
</div>
...
- Related systems: [[Waste Gas]], [[EDGs]]
