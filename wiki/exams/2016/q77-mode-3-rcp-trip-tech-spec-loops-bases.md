...
# 2016 Q77 — Mode 3 RCP trip Tech Spec application — RCS loops with rod control de-energized
...
<span style="font-size:10px;padding:2px 8px;background:#0d1220;color:#6b7280;border-radius:3px;">000015 G2.2.37 (SRO 4.6)</span>
</div>
