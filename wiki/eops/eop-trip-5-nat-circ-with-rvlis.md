---
title: "EOP-TRIP-5 — Natural Circulation Cooldown With RVLIS"
category: eops
status: draft
aliases:
  - EOP-TRIP-5
...
Maximum allowable RCS cooldown rate with RVLIS available: <span class="hi-exam">100&deg;F/hr for the entire cooldown</span>. Without RVLIS (EOP-TRIP-6), the rate is more restrictive: 50&deg;F/hr when T-Hots > 500&deg;F, then 100&deg;F/hr when T-Hots < 450&deg;F.
</div>

<div class="callout callout-exam">
<div class="callout-label">Exam — 2020 Q84</div>
Natural circulation rapid cooldown with RVLIS: maximum rate is <span class="hi-exam">100&deg;F/hr for the entire cooldown</span>. Without RVLIS: initial cooldown to 500&deg;F is limited to <span class="hi-exam">&lt; 50&deg;F/hr</span>, then &lt; 100&deg;F/hr afterwards.
</div>

<div class="callout callout-exam">
<div class="callout-label">Exam — 2018 Q8</div>
Per 1-EOP-TRIP-5 Step 4: before restarting an RCP, <span class="hi-exam">saturated conditions must first be established in the PZR</span>. The reason is to <span class="hi-exam">limit the PZR pressure DECREASE upon RCP restart</span>. Saturation determination requires converting psig to psia: at 2005 psig (2020 psia), T-sat = 637&deg;F. If PZR liquid temperature is 635&deg;F, the PZR is subcooled (not saturated). <span class="hi-trap">Trap: steam tables use psia, not psig. Also: the concern is pressure DECREASE, not increase. A water-solid pressurizer concern (pressure rise) applies during different plant conditions.</span>
</div>
...
- Related exam: [[2018 NRC Written Exam]], [[2022 NRC Written Exam]], [[2020 NRC Written Exam]]
