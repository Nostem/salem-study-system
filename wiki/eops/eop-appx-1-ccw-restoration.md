...
APPX-1 is for CCW Restoration during EOP-TRIP-1 (loading), not during the LOCA recirculation transfer. <span class="hi-exam">EOP-LOCA-3 does NOT transition to APPX-1 when no CCW pumps are running</span> — LOCA-3 step 11.2 with no CCW pumps directs operators to step 124 for single-train recirculation. <span class="hi-trap">Trap: APPX-1 is invoked from EOP-TRIP-1 step 17 to start a CCW pump during initial loading; it is NOT a recovery path within LOCA-3.</span>
</div>
...
- Related exam questions: [[2016 Q5]], [[2020 Q76]]
- Related JPMs: [[2018 JPM Sim-h]]
- Related exam: [[2016 NRC Written Exam]], [[2018 NRC Operating Exam]], [[2020 NRC Written Exam]]
