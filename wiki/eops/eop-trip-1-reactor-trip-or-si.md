...
<div class="callout callout-exam">
<div class="callout-label">Exam — 2015 Q2</div>
Rationale for the EOP-TRIP-1 diagnostic step sequence: <span class="hi-exam">SG pressure is checked (for a faulted SG / Main Steam Line break) before the tube-rupture (SGTR) criteria</span>, because a <span class="hi-exam">high-energy steam break can mask other failures</span>. Identifying a faulted SG first therefore takes the higher priority in the diagnostic sequence.
</div>

<div class="callout callout-exam">
<div class="callout-label">Exam — 2015 Q51</div>
On uncontrollably rising steam flow (AB.STM-0001), after tripping and initiating MSLI: <span class="hi-exam">if the steam-leak source is isolated the crew goes to EOP-TRIP-1; if not, they initiate SI and go to TRIP-1</span>. See [[AB.STM-0001 — Excessive Steam Flow]], [[Main Steam]].
</div>

<div class="callout callout-exam">
<div class="callout-label">Exam — 2015 Q74</div>
On a total loss of all AC power, either EOP-TRIP-1 or EOP-LOPA-1 may be entered. <span class="hi-exam">If TRIP-1 is entered, its flowpath kicks out to LOPA-1 (no 4KV vital buses energized) before reaching the SI evaluation step</span> — so the SI step is not performed. See [[EOP-LOPA-1 — Loss of All AC Power]], [[OP-AA-101-111-1003 — Use of Procedures]].
</div>

<div class="callout callout-scenario">
<div class="callout-label">Scenario — 2015 #1</div>
LBLOCA (RCS loop 22 catastrophic failure) with <span class="hi-exam">failure of automatic SI actuation</span>. RO performs TRIP-1 immediate actions: confirms the Rx trip, trips the Main Turbine, reports at least one 4KV vital bus energized, then — recognizing a demand for SI exists but SI has not initiated — <span class="hi-exam">manually initiates SI</span>. <span class="hi-exam">CT#1 (CT-5):</span> when both 21 and 22 RHR pumps fail to start on the SEC signal, the crew <span class="hi-exam">blocks 2A and 2B SECs, resets 2A and 2B SECs, and manually starts both RHR pumps (at least one low-head ECCS pump) BEFORE transitioning out of TRIP-1</span>. Crew verifies ECCS flow paths (charging ≥100 gpm, SI ≥100 gpm, RHR ≥300 gpm on both 21/22SJ49s), stops all RCPs per CAS, then confirms LOCA transition criteria and goes to EOP-LOCA-1. See [[ECCS]], [[RHR]], [[SECs]], [[EOP-LOCA-1 — Loss of Reactor or Secondary Coolant]].
</div>

<div class="callout callout-jpm">
<div class="callout-label">JPM — 2015 Sim-g</div>
On a total loss of Component Cooling Water, the "Stopping Reactor Coolant Pumps" attachment of AB.CC-0001 / AB.RCP-0001 directs the crew to trip the reactor, stop 21-24 RCPs, isolate letdown, swap charging suction to the RWST, isolate the VCT, and then <span class="hi-exam">GO TO 2-EOP-TRIP-1, Reactor Trip or Safety Injection</span> (returning to the attachment at SM/CRS discretion). See [[AB.CC-0001 — Loss of Component Cooling Water]].
</div>

<div class="callout callout-scenario">
<div class="callout-label">Scenario — 2015 #2</div>
Entered twice. First the CRS directs a <span class="hi-exam">manual reactor trip</span> with power &gt; P-9 because the Main Generator must come off line (MPT Sudden Pressure / FP deluge); RO performs immediate actions and reports <span class="hi-exam">SI not actuated and not required</span> → EOP-TRIP-2. Re-entered from the TRIP-2 CAS when a 2nd PZR pressure channel (PT457) fails low causing an <span class="hi-exam">auto Inadvertent SI on Lo PZR pressure</span> — RO backs up SI, crew verifies safeguards and TRIP-3 transition criteria → EOP-TRIP-3. See [[EOP-TRIP-2 — Reactor Trip Response]], [[EOP-TRIP-3 — SI Termination]].
</div>

<div class="callout callout-scenario">
<div class="callout-label">Scenario — 2014 #3</div>
After an SBLOCA, the CRS directs a reactor trip and SI. In TRIP-1 immediate actions, the <span class="hi-exam">first SI train attempted fails to initiate</span> — RO initiates SI on the other train; a coincident LOOP drops offsite power (2A/2B EDGs supply their buses). The crew must <span class="hi-exam">establish high-head SI flow by manually starting a charging pump (CT#2) before transitioning out of TRIP-1</span>, since both centrifugal charging pumps are unavailable for auto injection (one failed earlier, the other fails to auto-start on the SEC). After Rx trip stabilization, the CRS transitions to EOP-LOCA-1. See [[2014 Scenario 3]], [[EOP-LOCA-1 — Loss of Reactor or Secondary Coolant]].
</div>
...
- Related exam: [[2014 NRC Written Exam]], [[2014 NRC Operating Exam]], [[2015 NRC Written Exam]], [[2015 NRC Operating Exam]], [[2016 NRC Written Exam]], [[2017 NRC Operating Exam]], [[2018 NRC Written Exam]], [[2018 NRC Operating Exam]], [[2019 NRC Written Exam]], [[2019 NRC Operating Exam]], [[2020 NRC Written Exam]], [[2022 NRC Written Exam]], [[2023 NRC Written Exam]], [[2022 NRC Operating Exam]], [[2020 NRC Operating Exam]], [[2016 NRC Operating Exam]], [[2012 NRC Written Exam]]
