...
export default defineConfig({
  testDir: './tests',
  testMatch: ['ui-test.ts', 'quiz-test.ts', 'quiz-v2-test.ts', 'quiz-v2-play-test.ts', 'quiz-v2-review-test.ts', 'graph-v2-test.ts', 'auth-test.ts', 'contact-test.ts', 'navigation-test.ts', 'history-test.ts'],
  timeout: 30000,
  use: {
