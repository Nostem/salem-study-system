import { createAdminClient, createPublicClient, jsonResponse, readJsonBody, requirePost } from '../_shared/http.ts';
...
Deno.serve(async (req) => {
  ...
  if (!admin || !publicClient) return jsonResponse({ error: 'server_not_configured' }, 500);
