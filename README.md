...
GitHub Pages/Vercel deploy the static Astro site only. Supabase migrations and Edge Function deploys are separate.
...
5. Push frontend/static changes and watch GitHub Pages/Vercel.
